                ...
                <CardContent className="p-3 sm:p-4 flex flex-col md:flex-row md:items-center md:justify-between space-y-3 md:space-y-0 md:space-x-4 bg-card hover:bg-muted/30 transition-colors duration-200">
                  <div className="flex items-start space-x-3 sm:space-x-4 flex-grow">
                    ...
                    <div className="min-w-0"> 
                      <h3 className={cn("text-base sm:text-lg font-semibold font-headline", task.isCompleted ? "line-through text-muted-foreground" : "text-foreground")}>{task.title}</h3>
                      <TypewriterText 
                        ...
                        showCaret={false}
                      />
                      <div className="mt-1.5 sm:mt-2 flex flex-col sm:flex-row sm:items-center text-xs text-primary flex-wrap gap-x-3 gap-y-1">
                        <span className="flex items-center"><Award className="w-3 h-3 sm:w-3.5 sm:h-3.5 mr-1 sm:mr-1.5" /> XP: {task.xp}</span>
                        <span className="flex items-center"><RewardIcon className="w-3 h-3 sm:w-3.5 sm:h-3.5 mr-1 sm:mr-1.5 text-accent" /> Reward: {task.reward.name}</span>
                      </div>
                    </div>
                  </div>
                  <Button 
