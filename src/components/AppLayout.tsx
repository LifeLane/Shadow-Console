...
import { BrainCircuit, Landmark, Gift, User, BarChart, Sparkles, Pickaxe, Sun, Atom, Droplets, SquareTerminal, Scroll, ListChecks } from 'lucide-react';
...
type TabId = 'wallet' | 'trade' | 'mind' | 'missions' | 'profile' | 'airdrop';
